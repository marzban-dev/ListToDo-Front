      ...
      >
        <div
          className={[
            ...
            isSignedUp === 1 ? "form-success-request-layer-active" : null,
          ].join(" ")}
        >
        ...
        <div className="form-input-container">
          <div className="form-input">
            ...
            <div
              className={[
                "form-input-line",
                errors.email ? "form-input-error-line-active" : null,
              ].join(" ")}
            ></div>
          </div>
          <div
            className={[
              "form-input-box-error",
              errors.email ? "form-input-error-box-active" : null,
            ].join(" ")}
          >
        ...
        <div className="form-request-error-box">
          <p>
            {isSignedUp === -1 ? "Signup failed. please try again later" : null}
          </p>
        </div>
