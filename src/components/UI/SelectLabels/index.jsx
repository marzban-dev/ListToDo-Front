...
const SelectLabels = ({labelsList, setLabelsList}) => {
    ...
    return (
        <div className="labels" onBlur={closeLabelsMenu}>
            <MatchedLabels
                labels={labels}
                taskLabels={labelsList}
                setTaskLabels={setLabelsList}
            ...
            <SelectedLabels taskLabels={labelsList} setTaskLabels={setLabelsList} labels={labels}/>
        </div>
    );
};
