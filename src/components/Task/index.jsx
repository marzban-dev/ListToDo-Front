...
const Task = ({task}) => {
        ...
        const fetchAndShowSubTasks = catchAsync(async () => {
        ...
        }, null, () => setIsSubTasksLoading(false));
        ...
        return (
            ...
            >
                ...
                <div className="task-info">
                    ...
                    <button className="task-info-item task-info-sub-tasks" onClick={fetchAndShowSubTasks}>
                        {!isSubTasksLoading ? (
                            <>
